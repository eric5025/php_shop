<?php
include "../common.php"; 
$day1 = get_param("day1", date("Y-m-d", strtotime("-1 month")));
$day2 = get_param("day2", date("Y-m-d"));
$sel1 = get_param("sel1", "0");
$sel2 = get_param("sel2", "1");
...
$sql = "SELECT * FROM jumun1 WHERE jumunday BETWEEN '$day1' AND '$day2' $where ORDER BY id DESC";
                    ...
                    <td>
                        <div class="d-sm-inline-flex">
                            ...
                            for ($i = 1; $i < count($a_state); $i++) {
                                ...
                                $optionColor = "black";
                                if ($i == 5) $optionColor = "blue"; 
                                if ($i == 6) $optionColor = "red";  
